...
import { 
  ...
  FaLaptop, 
  FaCar, 
  FaUser, // Corrected import for user friends icon
  FaTruck, 
  FaStore, 
  FaBullhorn, // Icon for BillBoard
  FaUtensils // Icon for Food
} from 'react-icons/fa';

const SideNavbar = () => {
  const navItems = [
    { name: "BillBoard", icon: <FaBullhorn style={{ color: '#FF4500' }} />, path: "/dashboard/billboard" }, // BillBoard at the top
    { name: "Food", icon: <FaUtensils style={{ color: '#FFD700' }} />, path: "/dashboard/food" }, // Food after BillBoard
    ...
    { name: "Affiliates", icon: <FaUser style={{ color: '#4CAF50' }} />, path: "/dashboard/affiliates" },
    { name: "Delivery Agents", icon: <FaTruck style={{ color: '#2196F3' }} />, path: "/dashboard/deliveryagents" },
    { name: "Shops", icon: <FaStore style={{ color: '#FF9800' }} />, path: "/dashboard/shops" }
  ];

  return (
    <div className="w-auto h-auto bg-gradient-to-br from-gray-900 to-black bg-opacity-80 backdrop-blur-lg shadow-lg sticky right-0 top-0 z-auto">
